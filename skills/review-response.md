...
|------|------------|---------|
| `file.ts:123` | "Missing null check" | ✅ Already guarded at line 120 |
...
> 💡 **Potential Skill**: This review flagged [pattern]. Consider adding a skill to [handle/validate] this pattern automatically.

---
*Generated by pre-push-guardian*
```
...
*Flagged by pre-push-guardian for review accuracy improvement*
```
...
*Documented by pre-push-guardian*
```
